...
<div class="container">
	<div class="row">
		<div class="col-12">
 			<h6>Search result for <i class="keyword"><?php echo $keyword; ?></i> :</h6>
 			<hr class="light-100">
 		</div>
 	</div>
 </div>
...
<div class="container padding margin">
	<div class="row">
		<?php
			$sql="select * from products where is_deleted=0 and tags like '%".$keyword."%'";
		...
		<?php }} else{ ?>
		<div class="col-12">
			<p>Sorry! No products found for <em class="keyword"><?php echo $keyword; ?></em>. Try searching something like t-shirt, black, women etc.</p>
			</div>
		<?php } ?>
	</div>
</div>
